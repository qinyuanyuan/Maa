    ...
    return (
      <div className={MainCss.main}>
        ...
        <div className={MainCss.one}>
          ...
          <textarea cols="50" rows="10" name="text1" value={this.state.text1} onChange={e => this.changeValue(e)} ></textarea>
        </div>
        ...
        <div className={MainCss.footer}>
          ...
          <div className={MainCss.textarea}>
            <textarea cols="50" rows="10" name="text3" value={this.state.text3} onChange={e => this.changeValue(e)}></textarea>
          </div>
        </div>
